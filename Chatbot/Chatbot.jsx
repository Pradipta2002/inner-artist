...
const steps = [
    ...
    },
    {
        ...
        options: [
            ...
            { value: 6, label: 'Drawing of yourself conveying an emotion', trigger: 'end' },
            { value: 7, label: 'Different flowers showcased in a vase', trigger: 'end' },
            { value: 8, label: 'Well-known buildings', trigger: 'end' },
            { value: 9, label: 'Various seashells lying on the beach shore', trigger: 'end' },
            { value: 10, label: 'Your version of a cover of the book you love', trigger: 'end' },
            ...
            { value: 15, label: 'A flower showing all of its parts in detail', trigger: 'end' },
            { value: 16, label: 'Drawing of the space capturing all the planets', trigger: 'end' },
            { value: 17, label: 'Cartoon characters doing everyday human routines like cooking or washing dishes', trigger: 'end' },
            { value: 18, label: 'Fantasy animals like dragons', trigger: 'end' },
            { value: 19, label: 'Design an outfit you would love to wear', trigger: 'end' },
            { value: 20, label: 'Capture different activities happening on the street', trigger: 'end' },
            { value: 21, label: 'Abstract painting of what you’re feeling now', trigger: 'end' },
            ...
            { value: 25, label: 'Drawing of people with different skin tones and cultures together', trigger: 'end' },
            { value: 26, label: 'Drawing Ideas', trigger: 'end' },
            { value: 27, label: 'An imaginary building', trigger: 'end' },
            { value: 28, label: 'Capture various activities happening in a market', trigger: 'end' },
            { value: 29, label: 'Mythical gods like Zeus', trigger: 'end' },
            { value: 30, label: 'Drawing that captures different parts of a machine', trigger: 'end' },
            ...
            { value: 34, label: 'Drawing of older people that you love and the wisdom they emit', trigger: 'end' },
            { value: 35, label: 'The clear sky with the moon and many stars', trigger: 'end' },
            { value: 36, label: 'Drawing of characters from your favorite movie or series', trigger: 'end' },
            { value: 37, label: 'Detailed drawing of a butterfly or any insect that you love', trigger: 'end' },
            { value: 38, label: 'Capture the activities happening in a farmhouse focusing on the farm animals', trigger: 'end' },
            { value: 39, label: 'Your favorite musicians on stage', trigger: 'end' },
            { value: 40, label: 'Turn ordinary objects into something in your imagination', trigger: 'end' },
            { value: 41, label: 'Different textures in one drawing', trigger: 'end' },
            { value: 42, label: 'Capture activities happening in an aesthetic cafe', trigger: 'end' },
            { value: 43, label: 'Brick patterns on a wall', trigger: 'end' },
            { value: 44, label: 'Abstract drawing inspired by your favorite song', trigger: 'end' },
            { value: 45, label: 'Detailed drawing of a human face', trigger: 'end' },
            { value: 46, label: 'Drawing capturing the parts of a traditional machine like a cassette player or typewriter', trigger: 'end' },
